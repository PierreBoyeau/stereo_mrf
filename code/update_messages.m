...
msg_center(y_ind, x_ind, l_ind) = data_cost(y_ind, x_left, l_ind)...
    + msg_up_prev(y_ind+1, x_ind, l_ind)...
    + msg_down_prev(y_ind-1, x_ind, l_ind)...
    + msg_left_prev(y_ind, x_ind+1, l_ind);
...
msg_other(y_ind, x_ind, l_ind) = repmat(min(msg_other(y_ind, x_ind, l_ind), [], 3), 1, 1, num_disp_value);
...
msg_center(y_ind, x_ind, l_ind) = data_cost(y_ind, x_right, l_ind)...
    + msg_up_prev(y_ind+1, x_ind, l_ind)...
    + msg_down_prev(y_ind-1, x_ind, l_ind)...
    + msg_right_prev(y_ind, x_ind-1, l_ind);
msg_other(y_ind, x_ind, l_ind) = data_cost(y_ind, x_ind, l_ind)...
    + msg_up_prev(y_ind+1, x_ind, l_ind)...
    + msg_down_prev(y_ind-1, x_ind, l_ind)...
    + msg_right_prev(y_ind, x_ind-1, l_ind)...
...
msg_up(y_ind, x_ind, l_ind) = min(msg_center(y_ind, x_ind, l_ind), msg_other(y_ind, x_ind, l_ind));
%%% Down
y_down = 3:height;
...
msg_down(y_ind, x_ind, l_ind) = min(msg_center(y_ind, x_ind, l_ind), msg_other(y_ind, x_ind, l_ind));



% 
% %%% VERSION 2 MARCHE QUAND MEME MIEUX
% %%% Left 
% x_left = 1:width-2;
% msg_center(y_ind, x_ind, l_ind) = data_cost(y_ind, x_left, l_ind)...
%     + msg_up_prev(y_ind+1, x_left, l_ind)...
%     + msg_down_prev(y_ind-1, x_left, l_ind)...
%     + msg_left_prev(y_ind, x_left+1, l_ind);
% msg_other(y_ind, x_ind, l_ind) = data_cost(y_ind, x_ind, l_ind) ...
%     + msg_up_prev(y_ind+1, x_ind, l_ind)...
%     + msg_down_prev(y_ind-1, x_ind, l_ind)...
%     + msg_left_prev(y_ind, x_ind+1, l_ind)...
...
% x_right = 3:width;
% msg_center(y_ind, x_ind, l_ind) = data_cost(y_ind, x_right, l_ind)...
%     + msg_up_prev(y_ind+1, x_right, l_ind)...
%     + msg_down_prev(y_ind-1, x_right, l_ind)...
%     + msg_right_prev(y_ind, x_right-1, l_ind);
% msg_other(y_ind, x_ind, l_ind) = data_cost(y_ind, x_ind, l_ind)...
%     + msg_up_prev(y_ind+1, x_ind, l_ind)...
%     + msg_down_prev(y_ind-1, x_ind, l_ind)...
%     + msg_right_prev(y_ind, x_ind-1, l_ind)...
...
% y_up = 1:height-2;
% msg_center(y_ind, x_ind, l_ind) = data_cost(y_up, x_ind, l_ind)...
%     + msg_up_prev(y_up+1, x_ind, l_ind)...
%     + msg_right_prev(y_up, x_ind-1, l_ind) ...
%     + msg_left_prev(y_up, x_ind-1, l_ind);
% msg_other(y_ind, x_ind, l_ind) = data_cost(y_ind, x_ind, l_ind)...
%     + msg_right_prev(y_ind, x_ind-1, l_ind)...
%     + msg_up_prev(y_ind+1, x_ind, l_ind)...
%     + msg_left_prev(y_ind, x_ind-1, l_ind)...
...
% y_down = 3:height;
% msg_center(y_ind, x_ind, l_ind) = data_cost(y_down, x_ind, l_ind)...
%     + msg_down_prev(y_down-1, x_ind, l_ind)...
%     + msg_right_prev(y_down, x_ind-1, l_ind) ...
%     + msg_left_prev(y_down, x_ind+1, l_ind);
% msg_other(y_ind, x_ind, l_ind) = data_cost(y_ind, x_ind, l_ind)...
%     + msg_down_prev(y_ind-1, x_ind, l_ind)...
%     + msg_right_prev(y_ind, x_ind-1,l_ind)...
%     +msg_left_prev(y_ind, x_ind+1, l_ind)...
